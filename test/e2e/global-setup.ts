    ...
    try {
        ...
        if (userId) {
            ...
            await client.query(`
                ...
                VALUES ($1, 'NL91ABNA0417164300', 'E2E Test User', 'Main Account', 5000.00, 'income', NOW()),
            ...
            await client.query(`
                ...
                VALUES ('E2E Groceries', 'expense', '🛒', '#ff6b6b', NOW()),
            ...
            await client.query(`
                ...
                VALUES ($1, 'E2E Vacation Fund', 2000.00, 500.00, 'medium', '2024-12-31', NOW()),
