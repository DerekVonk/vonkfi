...
describe('Category Management Tests', () => {
  ...
  describe('Category CRUD Operations', () => {
    ...
    it('should not delete a category that is in use by transactions', async () => {
      const category = await storage.createCategory({
        name: 'Used Category',
        type: 'essential'
      });
  ...
  describe('Category Validation', () => {
    it('should reject categories with invalid types', async () => {
    ...
    it('should reject categories with duplicate names', async () => {
      await storage.createCategory({
    ...
    it('should validate category colors are valid hex codes', async () => {
  ...
  describe('Category Hierarchy', () => {
    ...
    it('should handle category hierarchy depth limits', async () => {
  ...
  describe('Automatic Transaction Categorization', () => {
    ...
    it('should learn from manual categorization corrections', async () => {
      const category = await storage.createCategory({
        name: 'Gas Stations',
        type: 'essential'
      });
    ...
    it('should handle uncategorizable transactions gracefully', async () => {
      const account = await storage.createAccount({
        userId: testUserId,
        iban: 'GB12ABCD12345678901234',
        accountHolderName: 'Test User',
  ...
  describe('Category Analytics', () => {
    it('should provide spending analysis by category', async () => {
      const groceryCategory = await storage.createCategory({
        name: 'Groceries',
        type: 'essential'
      });
    ...
    it('should track category budgets vs actual spending', async () => {
  ...
  describe('Category Import/Export', () => {
    it('should export category definitions', async () => {
      await storage.createCategory({
        name: 'Export Test 1',
        type: 'essential',
        color: '#FF6B6B'
    ...
    it('should import category definitions', async () => {
      const categoryData = {
        categories: [
          {
